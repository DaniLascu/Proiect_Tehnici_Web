...
CREATE USER dani WITH ENCRYPTED PASSWORD 'dani';
GRANT ALL PRIVILEGES ON DATABASE proiect_tehnici_web TO dani;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO dani;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO dani;